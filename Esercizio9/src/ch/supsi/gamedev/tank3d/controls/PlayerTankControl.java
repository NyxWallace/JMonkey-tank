...
public class PlayerTankControl extends InputControl {

	private static final String[] ACTIONS = new String[]{"DriverCamera", "GunnerCamera", "Forward", "Backward", "StrafeLeft", "StrafeRight", "Left", "Right", "TurretLeft", "TurretRight", "CannonUp", "CannonDown", "Fire"};
	// Defaults
	...
	protected void controlUpdate(float tpf) {
		...
		if (stabilityControl != null) {
			stabilityControl.rotateTurret(turretDeltaAngle * FastMath.RAD_TO_DEG);
			stabilityControl.rotateCannon(cannonDeltaElevation * FastMath.RAD_TO_DEG);
		} else {
