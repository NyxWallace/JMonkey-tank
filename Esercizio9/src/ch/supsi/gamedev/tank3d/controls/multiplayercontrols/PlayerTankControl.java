...
public class PlayerTankControl extends AbstractControl implements TankControl, PhysicsListener, Cloneable {
	...
	//Defaults
	private static final float DEFAULT_FORWARD_FORCE = 700000.0f; // N
	private static final float DEFAULT_STRAFE_FORCE = 500000.0f; // N
	private static final float DEFAULT_BACKWARD_FORCE = 300000.0f; // N
	...
	private static final float DEFAULT_CANNON_IMPULSE = .0f; // Ns
	private static final float DEFAULT_RELOAD_TIME = .0f; // sec
	//Properties
	...
	private void initialize() {
		...
		compoundCollisionShape.addChildShape(new BoxCollisionShape(new Vector3f(.2f, .2f, .2f)), new Vector3f(0.0f, 0.25f, 0.0f));
		compoundCollisionShape.addChildShape(new BoxCollisionShape(new Vector3f(.2f, .2f, .2f)), new Vector3f(0.0f, 0.25f, 0.0f));
		compoundCollisionShape.addChildShape(new BoxCollisionShape(new Vector3f(.2f, 0.2f, .2f)), new Vector3f(-3.5f, -0.25f, -2.5f));
		compoundCollisionShape.addChildShape(new BoxCollisionShape(new Vector3f(.2f, 0.2f, .2f)), new Vector3f(3.5f, -0.25f, -2.5f));
		compoundCollisionShape.addChildShape(new CylinderCollisionShape(new Vector3f(.2f, 0.2f, .2f), 1), new Vector3f(0.0f, 2.0f, -2.36f));
