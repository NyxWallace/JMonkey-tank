...
public class DeadTankControl extends AbstractControl implements PhysicsListener, Cloneable {
	...
	public void physicsUpdate(float tpf) {
		...
		TankControl tankControl = originalTank.getControl(TankControl.class);
		Vector3f linearVelocity = tankControl.getVelocity();
		Vector3f angularVelocity = tankControl.getAngularVelocity();
